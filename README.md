...
- 'configs.py': Defines model and training configuration classes including DownsampledDistilBertConfig which is a configuration class that store the configuration of a DistilBertModel
