#Used https://github.com/huggingface/transformers/blob/main/src/transformers/models/distilbert/configuration_distilbert.py as a base

from transformers import PretrainedConfig

class DownsampledDistilBertConfig(PretrainedConfig):
    r"""
